...
class Email(models.Model):
    ...
    backend_alias = models.CharField(
        _("Backend alias"), blank=True, default="", max_length=64
    )
    ...
    def prepare_email_message(self):
        ...
        # use template only of there is no message str yet given.
        if not self.message and not self.html_message and self.template:
